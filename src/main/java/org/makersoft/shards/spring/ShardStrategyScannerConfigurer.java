...
//
//import org.makersoft.shards.annotation.ShardedReducer;
//import org.makersoft.shards.strategy.reduce.ShardReduceStrategyContext;
...
// * @author Feng Kuok
// */
//public class ShardStrategyScannerConfigurer implements BeanDefinitionRegistryPostProcessor,
...
//			super.addIncludeFilter(new AnnotationTypeFilter(ShardedReducer.class));
//
...
//				beanDef.setBeanClass(ShardReduceStrategyContext.class);
//
